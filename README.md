...
## 개발 후기
### 아쉬운 점
#### 1. 몬스터들의 애니메이션과 사운드를 자연스럽게 연결시키지 못 함 (걸을 때와 공격 시)
#### 2. 스킬이나 새로운 총기, 새로운 이동기를 더 넣지 못함

### 배운 것
#### 1. 견착을 할 때나 줌을 할 때의 총의 위치를 어디에 둬야할 지 어려웠는데 다른 FPS게임을 해보며 보기 좋은 자리를 배움
#### 2. 유니티 AI에서 NavemeshAgent는 메모리를 많이 잡기 때문에 많은 오브젝트에 사용할 때는 효율적이지 못 함
